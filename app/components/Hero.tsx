            ...
            <div className='flex flex-col justify-center h-full gap-6'>
                <div className='flex gap-4 items-end'>
                    <Link href={"https://github.com/kaykyls"} target='_blank' className='cursor-pointer group'>
                        <svg className='fill-dark-blue dark:fill-gray group-hover:fill-blue-600 transition' width="34" height="36" viewBox="0 0 34 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href={"https://www.linkedin.com/in/devkayky"} target='_blank' className='cursor-pointer group'>
                        <svg className='fill-dark-blue dark:fill-gray group-hover:fill-blue-600 transition' width="31" height="30" viewBox="0 0 31 30" fill="none" xmlns="http://www.w3.org/2000/svg">
