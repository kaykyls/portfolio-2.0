...
const Hero = () => {
  return (
    <main style={{backgroundImage: `url(${heroBg.src})`}} className='h-screen bg-cover bg-light-gray'>
        {/* <div className=' w-80 h-80 bg-blue-600 rounded-full absolute  inset-x-1/4 inset-y-96 blur-3xl scale-150 opacity-20'>

        </div>
        <div className='w-96 h-80 bg-violet-700 rounded-full absolute inset-x-1/2  inset-y-64 blur-3xl scale-150 opacity-20'>
