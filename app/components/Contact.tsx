...
const Contact = () => {
    return (
        <section className='bg-light-gray py-24 flex flex-col items-center'>
            <div className='mb-24 flex flex-col items-center gap-2'>
                <h2 className='text-blue-600 font-medium text-5xl'>Contact</h2>
                <p className='text-dark-gray text-xl'>Any questions? Get in touch!</p>
            </div>
            <div className="container mx-auto flex justify-between">
                <div className='flex flex-col gap-8'>
                    <div className='flex flex-col'>
                        <h4 className='text-black font-semibold text-3xl mb-4'>Socials</h4>
                        <Link href={"https://instagram.com/dev.kayky"} target='_blank' className='text-dark-gray text-xl'>Instagram</Link>
                        <Link href={"https://linkedin.com/in/devkayky"} target='_blank' className='text-dark-gray text-xl'>LinkedIn</Link>
                        <Link href={"https://github.com/kaykyls"} target='_blank' className='text-dark-gray text-xl'>GitHub</Link>
                    </div>
                    <div className='flex flex-col'>
                        <h4 className='text-black font-semibold text-3xl mb-4'>Email</h4>
                        <Link href={"mailto:dev.kayky@gmail.com"} className='text-dark-gray text-xl'>dev.kayky@gmail.com</Link>
                    </div>
                </div>
                <div className='flex w-[560px] min'>
                    <form action="" className='flex flex-col w-full gap-4'>
                        ...
                        <button className='py-4 bg-gradient-to-r text-xl from-gradient-light-blue to-gradient-dark-blue' type='submit'>Contact Me</button>
                    </form>
                </div>
            </div>
