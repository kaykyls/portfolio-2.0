        ...
        <div className='group w-full flex justify-center flex-col-reverse md:flex-row gap-10 md:gap-40 md:even:flex-row-reverse'>
            <div className='flex flex-col justify-end'>
                ...
                <div className='flex gap-2'>
                    <Link target='_blank' className='text-black group/repo hover:text-blue-600 transition font-medium flex px-4 py-2 bg-light-gray rounded gap-4 text-base items-center' href={repository}>Repo <svg className='fill-black group-hover/repo:fill-blue-600 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link target='_blank' className='text-black group/preview hover:text-blue-600 transition font-medium flex px-4 py-2 bg-light-gray rounded gap-4 text-base items-center' href={demo}>Live Preview <svg className='fill-black group-hover/preview:fill-blue-600 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='shadow-sm md:shadow-xl relative rounded-3xl before:content-[""] before:h-full before:w-64 md:before:w-96 before:left-[-32px] group-even:before:bg-violet-700 group-odd:before:bg-blue-600 before:absolute before:rounded-full before:blur-3xl before:scale-150 before:opacity-10 before:z-0'>
                <div className='overflow-hidden rounded-3xl'>
                    <Link href={demo} target='_blank'>
                        <Image
                            className='hover:scale-110 transition duration-300 rounded-3xl h-[250px] w-[375px] md:w-[525px] md:h-[325px] object-cover z-30 relative'
                            src={image}
                            width={525}
                            height={325}
                            alt={title}
