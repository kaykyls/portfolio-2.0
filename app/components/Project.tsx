        ...
        <div className='group w-full flex justify-center flex-col-reverse md:flex-row gap-10 md:gap-20 lg:gap-40 md:even:flex-row-reverse'>
            <div className='flex flex-col justify-end'>
                ...
                <div className='mb-4 mt-2'>
                    <h2 className='text-black dark:text-white font-semibold text-3xl'>{title}</h2>
                </div>
                <div className='max-w-xl'>
                    <p className='text-dark-gray dark:text-gray text-base'>{description}</p>
                </div>
                <div className='my-10'>
                ...
                <div className='flex gap-2'>
                    <Link target='_blank' className='text-black dark:text-gray group/repo hover:text-blue-600 dark:hover:text-blue-400 transition font-medium flex px-4 py-2 bg-light-gray dark:bg-darker-blue rounded gap-4 text-base items-center' href={repository}>Repo <svg className='fill-black dark:fill-gray group-hover/repo:fill-blue-600 dark:group-hover/repo:fill-blue-400 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_329_691)">
                    ...
                    <Link target='_blank' className='text-black dark:text-gray group/preview hover:text-blue-600 dark:hover:text-blue-400 transition font-medium flex px-4 py-2 bg-light-gray dark:bg-darker-blue rounded gap-4 text-base items-center' href={demo}>Live Preview <svg className='fill-black dark:fill-gray group-hover/preview:fill-blue-600 dark:group-hover/preview:fill-blue-400 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_329_693)">
            ...
            <div className='shadow-sm md:shadow-xl relative rounded-3xl before:content-[""] before:h-full before:w-64 md:before:w-96 before:left-[-32px] group-even:before:bg-violet-700 group-odd:before:bg-blue-600 before:absolute before:rounded-full before:blur-3xl before:scale-150 before:opacity-20 before:z-0'>
                <div className='overflow-hidden rounded-3xl'>
                    <Link href={demo} target='_blank'>
                        <Image
                            className='hover:scale-110 transition duration-300 rounded-3xl h-[250px] w-full md:w-[525px] md:h-[325px] object-cover z-30 relative'
                            src={image}
                            width={525}
                            height={325}
                            alt={title}
