        ...
        <div className='w-full flex justify-center gap-24 even:flex-row-reverse'>
            <div className='flex flex-col justify-end'>
                ...
                <div className='flex gap-8'>
                    <Link target='_blank' className='text-black font-medium flex gap-4 text-xl' href={repository}>Repo <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link target='_blank' className='text-black font-medium flex gap-4 text-xl' href={demo}>Live Preview <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='shadow-2xl relative rounded-3xl before:content-[""] before:h-full before:w-96 before:left-[-32px] before:bg-violet-700 before:absolute before:rounded-full before:blur-3xl before:scale-150 before:opacity-20 before:z-0'>
                <Link href={demo} target='_blank'>
                    <Image
                        className='rounded-3xl h-[350px] object-cover z-40 relative'
                        src={image}
                        width={550}
                        height={350}
                        alt={title}
