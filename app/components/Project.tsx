        ...
        <div className='group w-full flex items-center justify-center flex-col-reverse md:flex-row gap-6 lg:gap-20 md:even:flex-row-reverse'>
            <div className='flex flex-col justify-end'>
                ...
                <div className='flex gap-2'>
                    <Link target='_blank' className='text-black dark:text-gray group/repo hover:text-blue-600 dark:hover:text-blue-400 transition font-medium flex px-4 py-2 bg-light-gray dark:bg-darker-blue rounded gap-4 text-base items-center' href={repository}>{currentLanguage === "pt-br" ? "Repositório" : "Repository"} <svg className='fill-black dark:fill-gray group-hover/repo:fill-blue-600 dark:group-hover/repo:fill-blue-400 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link target='_blank' className='text-black dark:text-gray group/preview hover:text-blue-600 dark:hover:text-blue-400 transition font-medium flex px-4 py-2 bg-light-gray dark:bg-darker-blue rounded gap-4 text-base items-center' href={demo}>{currentLanguage === "pt-br" ? "Visualizar Projeto" : "Live Preview"} <svg className='fill-black dark:fill-gray group-hover/preview:fill-blue-600 dark:group-hover/preview:fill-blue-400 transition' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='flex md:w-auto shadow-sm md:shadow-xl relative rounded-2xl before:content-[""] before:h-full before:w-48 lg:before:w-80 xl:before:w-96 before:left-[-32px] group-even:before:bg-violet-700 group-odd:before:bg-blue-600 before:absolute before:rounded-full before:blur-3xl before:scale-150 before:opacity-20 before:z-0'>
                <div className='overflow-hidden md:w-auto flex rounded-2xl'>
